...
-- These are JobRole, BusinessTravel, OverTime, JobSatisfaction, ManagerRating, WorkLifeBalance

-- JobRole
SELECT TOP 1 JobRole, COUNT(*) AS Count
FROM Employee e
JOIN PerformanceRating p ON e.EmployeeID = p.EmployeeID
...
-- BusinessTravel
SELECT TOP 1 BusinessTravel, COUNT(*) AS Count
FROM Employee e
WHERE e.Attrition = 'Yes'
...
-- OverTime
SELECT TOP 1 OverTime, COUNT(*) AS Count
FROM Employee e
WHERE e.Attrition = 'Yes'
GROUP BY OverTime
ORDER BY Count DESC;
...
-- JobSatisfaction
SELECT TOP 1 CAST(JobSatisfaction AS DECIMAL(3,2)) AS JobSatisfaction, COUNT(*) AS Count
FROM Employee e
JOIN PerformanceRating p ON e.EmployeeID = p.EmployeeID
WHERE e.Attrition = 'Yes'
GROUP BY JobSatisfaction
...
-- ManagerRating
SELECT TOP 1 CAST(ManagerRating AS DECIMAL(3,2)) AS ManagerRating, COUNT(*) AS Count
FROM Employee e
JOIN PerformanceRating p ON e.EmployeeID = p.EmployeeID
WHERE e.Attrition = 'Yes'
GROUP BY ManagerRating
...
-- WorkLifeBalance
SELECT TOP 1 CAST(WorkLifeBalance AS DECIMAL(3,2)) AS WorkLifeBalance, COUNT(*) AS Count
FROM Employee e
JOIN PerformanceRating p ON e.EmployeeID = p.EmployeeID
WHERE e.Attrition = 'Yes'
